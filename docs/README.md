...
>
> * **![Matriz CSD](C:\Users\User\Desktop\TI1\docs\images\Matriz-de-Alinhamento-CSD.png)**: também conhecida por Matriz de Alinhamento, é uma ferramenta utilizada no Design Thinking para organizar informações e facilitar o processo de tomada de decisão e solução de problemas;
